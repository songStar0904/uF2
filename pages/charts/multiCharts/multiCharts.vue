<template>
	<view class="container">
	  <ff-canvas id="multi-bar-dom" canvas-id="multi-bar" :opts="drawBar" ref="drawBar"></ff-canvas>
	  <ff-canvas id="multi-scatter-dom" canvas-id="multi-scatter" :opts="drawScatter" ref="drawScatter"></ff-canvas>
	  <ff-canvas id="multi-radial-dom" canvas-id="multi-radial" :opts="drawRadial" ref="drawRadial"></ff-canvas>
	</view>
</template>
...
<script>
	...
	export default {
		...
		mounted() {
			this.$refs.drawBar.init(this.drawBar.onInit)
			this.$refs.drawScatter.init(this.drawScatter.onInit)
			this.$refs.drawRadial.init(this.drawRadial.onInit)
		}
	}
</script>
